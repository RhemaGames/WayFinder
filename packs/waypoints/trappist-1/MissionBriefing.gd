...
var info = {
	...
	"screens":[
		{"where":"leftscreen","file":"res://packs/waypoints/trappist-1/scenes/2DUI/trappist-1-info.tscn"},
		{"where":"rightscreen","file":"res://packs/waypoints/trappist-1/scenes/2DUI/trappist-2-info.tscn"}
		],
	"missions":[
		{"title":"Arrival","file":"res://packs/waypoints/trappist-1/encounters/Arrival.tscn"},
		{"title":"Exo-Tera Firma"},
